...
public class AddTimesheet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            // 5. ko cho add trước tương lai - qk thì có. hoặc cho add trước nhưng ngay tuần sau
            String dayStartString = request.getParameter("dayStart");
            String dayEndString = request.getParameter("dayEnd");
