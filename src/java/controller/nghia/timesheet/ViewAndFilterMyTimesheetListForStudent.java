 ...
 * @author Admin
 */
public class ViewAndFilterMyTimesheetListForStudent extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ViewAndSearchTimesheet</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ViewAndSearchTimesheet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (user.getRoleID() == 1) {
            ...
            ArrayList<TimeSheet> timesheetList = timesheetDao.getTimeSheetByUserId(user.getUserID());
        ...
        //lấy hết các timesheet của tuần và các timesheet entry nằm trong đó
    }
