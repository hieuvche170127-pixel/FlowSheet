...
<head>
    ...
    <title>Update Task Report - LAB Timesheet</title>
        ...
        <div class="col-lg-8 col-md-10 col-sm-12">
            <div class="card create-card">
                <div class="card-header text-center bg-transparent">
                    ...
                    <h3 class="mb-1 fw-bold text-dark">Update Task Report</h3>
                    <p class="text-muted mb-0">Edit your report details</p>
                </div>
                <div class="card-body p-4 p-xl-5">
                    ...
                    <form action="${pageContext.request.contextPath}/task-report/update" method="post">
                        ...
                        <div class="form-floating mb-3">
                            <select class="form-select" id="taskId" name="taskId" required>
                                ...
                                <c:forEach var="task" items="${tasks}">
                                    <option value="${task.taskId}" ${task.taskId == report.taskId ? 'selected' : ''}>
                                        ${task.taskName}
                        ...
                        <div class="form-floating mb-3">
                            <textarea class="form-control" id="reportDescription" name="reportDescription"
                                      style="height: 150px" placeholder="Describe your work progress...">${report.reportDescription}</textarea>
                            ...
                            <div class="col-md-6">
                                <div class="form-floating mb-3">
                                    <input type="number" class="form-control" id="estimateWorkPercentDone"
                                           ...
                                           placeholder="0.0" value="${report.estimateWorkPercentDone}">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating mb-3">
                                    <input type="number" class="form-control" id="totalHourUsed"
                                           ...
                                           placeholder="0.0" value="${report.totalHourUsed}">
                        ...
                        <div class="form-floating mb-4">
                            <select class="form-select" id="timesheetEntryId" name="timesheetEntryId">
                                ...
                                <c:forEach var="entry" items="${timesheetEntries}">
                                    <option value="${entry.entryId}" ${entry.entryId == report.timesheetEntryId ? 'selected' : ''}>
