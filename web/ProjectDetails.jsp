                            ...
                            <div class="d-flex">
                                ...
                                <div>
                                    ...
                                    <div class="text-muted small mb-3">
                                        <span class="fw-bold text-uppercase text-secondary me-2" style="font-size: 0.9rem;">
                                            <i class="bi bi-circle-fill" style="font-size: 8px;
                                            vertical-align: middle;"></i> ${project.status}
                                        </span>
                                    ...
                                    <tbody>
                                        ...
                                        <c:forEach var="task" items="${tasks}" varStatus="status">
                                            <tr>
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${not empty task.assigneeNames}">
                                                            <div class="d-flex align-items-center">
                                                                <div class="rounded-circle bg-secondary text-white d-flex justify-content-center align-items-center me-2" style="width:24px;
                                                                    height:24px;
                                                                    font-size:10px;">
                                                ...
                                                <td>
                                                    <c:choose>
                                                        <c:when test="${task.status == 'COMPLETE'}"><span class="badge badge-soft-success">Complete</span></c:when>
                                                        <c:when test="${task.status == 'IN_PROGRESS'}"><span class="badge badge-soft-primary">In Progress</span></c:when>
                                                        <c:otherwise><span class="badge badge-soft-secondary">To Do</span></c:otherwise>
                                                    </c:choose>
                                                </td>
                                    ...
                                    <tbody>
                                        <c:forEach var="member" items="${members}">
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="rounded-circle bg-success text-white d-flex justify-content-center align-items-center me-3" style="width:35px;
                                                            height:35px;">
